...
declare_id!("9QFrtsDpQXPm5p62iKvY8VH74WvyfdAe9pTTv9oxM9Vf");
...
pub mod journal {
    ...
    pub fn delete_entry(_ctx: Context<CreateEntry>, _title: String) -> Result<()> {
        Ok(())
    }
}
...
pub struct CreateEntry<'info> {
    #[account(init, seeds = [title.as_bytes(), owner.key().as_ref()],bump, payer = owner, space =8 + JournalEntryState::INIT_SPACE, )]
